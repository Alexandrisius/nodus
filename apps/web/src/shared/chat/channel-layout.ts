 ...
 *  ленты БЕЗ горизонтали и БЕЗ точки (точка на кромке/срезе читалась ложным
 *  узлом — вердикт владельца): сегмент обрыва идёт вдоль кромки ВНУТРИ
 *  контейнера канала, за его пределы (шапка страницы, композер) ребро не
 *  выходит. */
