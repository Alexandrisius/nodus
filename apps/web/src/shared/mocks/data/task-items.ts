// I5-обоснование: плоский мок-набор задач (данные, не god-object) — одна
// ответственность «демо-контент задач», деление разорвало бы ссылки
// элементов друг на друга (подзадачи/связи внутри одного массива).
...
export const demoTasks: TaskListItem[] = [
  ...
  // Поручения ПП-58/ПП-59 резолюции Р-57 по письму Вх-2026/115 (см. tasks.ts).
  mk({
    id: tid(12),
    number: 112,
    ...
    checklistTotal: 0,
    source: 'letter',
    updatedAt: isoAgo(1, 16),
  }),
  mk({
    id: tid(13),
    number: 113,
    title: 'Проверить ведомость расхода стали по маркам',
    stage: stageNew,
    priority: 'normal',
    deadline: isoIn(3),
    creator: userRef(userIds.shaiderova),
