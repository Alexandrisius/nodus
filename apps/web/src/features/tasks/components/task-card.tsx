...
/** Ширина панели «О задаче»: на неё же сужается чат по общему канону буфера
 *  (ниже — пол чата, дальше двигается левая зона); панель полновысотная и
 *  занимает верхний бар, геометрия Битрикс24 15.09.2026. */
