...
- **Координаты снаппятся внутри к сетке ФИЗИЧЕСКИХ пикселей** (`snapToPixel` + `useDevicePixelRatio`, path и порты согласованно) — передавать измеренные значения как есть; без снаппинга прямые сегменты вдвое бледнее локтей при зуме ≠ 100% и Windows-скейлинге 125/150%.
