...
- **Координаты снаппятся внутри к полупиксельной сетке** (`snapHalf`, path и порты согласованно) — передавать измеренные значения как есть; без снаппинга прямые сегменты вдвое бледнее локтей при зуме ≤ 100%.
