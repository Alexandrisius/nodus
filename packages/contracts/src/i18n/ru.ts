...
export const ui = {
   ...
   *  не путать с глобальным «Умным поиском» портала — лупа в топбаре). */
  filters: {
    title: 'Фильтр',
    reset: 'Сбросить',
  ...
  tasks: {
    ...
    searchInList: 'Поиск в задачах…',
    searchInProject: 'Поиск в задачах проекта…',
    searchInAssignee: 'Поиск в задачах сотрудника…',
    roleLabel: 'Роль',
    roles: {
  ...
  employees: {
    ...
    email: 'Почта',
    viewList: 'Список',
    searchInList: 'Поиск сотрудников…',
    searchProjects: 'Поиск в проектах сотрудника…',
